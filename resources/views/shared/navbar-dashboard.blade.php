<nav class="navbar navbar-expand-lg navbar-dark navbar-custom-dashboard">
    <div class="container">
            ...
            <ul class="navbar-nav my-2 my-lg-0">
                @if (Auth::guest())
                    <li class="nav-item mx-3">
                        <a class="nav-link text-white navbar-item" href="{{ route('login') }}">Iniciar sesión</a>
                    </li>
                    <li class="nav-item mx-3">
                        <a class="nav-link text-white navbar-item" href="{{ route('register') }}">Registrarme</a>
                    </li>
                @else
